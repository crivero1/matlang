	...
	\left[\begin{smallmatrix}
       ...
       \vphantom{\int\limits^x}\smash{\vdots} &\vphantom{\int\limits^x}\smash{\vdots} & \vphantom{\int\limits^x}\smash{\vdots} & \vphantom{\int\limits^x}\smash{\vdots} \\
        ...
        0 & 0 & 0 & 0 \\
         \vphantom{\int\limits^x}\smash{\vdots} &\vphantom{\int\limits^x}\smash{\vdots} & \vphantom{\int\limits^x}\smash{\vdots} & \vphantom{\int\limits^x}\smash{\vdots} \\
        0 & 0 & 0 & 0
    \end{smallmatrix}\right]}_{\text{Result of $e_{\mathsf{isplus}}$ and $e_{\mathsf{isprod}}$}}
		\underbrace{\left[\begin{smallmatrix}
        \texttt{id}_1 & v_1 & 0 & 0 \\
        \texttt{id}_2 & v_2 & 0 & 0 \\
          \vphantom{\int\limits^x}\smash{\vdots} &\vphantom{\int\limits^x}\smash{\vdots} & \vphantom{\int\limits^x}\smash{\vdots} & \vphantom{\int\limits^x}\smash{\vdots} \\
    ...
    \left[\begin{smallmatrix}
       ...
       \vphantom{\texttt{id}_1}  0 & 0 & 0 & 0 \\
	    \vphantom{\texttt{id}_1}  0 & 0 & 0 & 0 \\
         \vphantom{\int\limits^x}\smash{\vdots} &\vphantom{\int\limits^x}\smash{\vdots} & \vphantom{\int\limits^x}\smash{\vdots} & \vphantom{\int\limits^x}\smash{\vdots} \\
        0 & 0 & 0 & 0
    \end{smallmatrix}\right]}_{\text{Result of $e_{\mathsf{isone}}$ and $e_{\mathsf{isinput}}$}}.
	$$
\caption{sksk}
\end{figure}
...
as depicted in Figure~\ref{}. To simulate $\textsc{Extend}$ we define
$$
e_{\mathsf{extend}}:=e_{\mathsf{ext\_plus}}+e_{\mathsf{ext\_prod}}+e_{\mathsf{ext\_one}}+e_{\mathsf{ext\_input}},
$$
where
    \begin{align*}\allowdisplaybreaks
      e_{\mathsf{ext\_plus}}&:= \textsf{isplus}\bigl(G^T\cdot G_{\mathsf{top}}\bigr)\times \Bigl( G + 
       \mathsf{Next}\cdot G_{\mathsf{top}} \cdot \textsf{getfirst}\bigl(G^T\cdot G_{top}\bigr)^T  + \\
