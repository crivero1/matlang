...
\floris{I am confused here. Does prod-matlang include order information ($S_<$) by default
or not? Here it seems that it is, but then in the diagram it is explicitly added?}
