...
\domagoj{It took me a while to figure out what $e_1(v)$ is. We use this all over the paper, and do not really introduce it, apart from a comment in Example 3.1. Not sure if we should define all the expressions by specifying the variables so that it does not get lost.}
