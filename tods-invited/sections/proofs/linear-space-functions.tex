...
\subsubsection{Generalized iteration mechanism}\label{subsubsec:generalloop}
...
variable $X_i$ and to evaluate $e_i$ we thus first extract all columns separately, by means of $X\cdot e_{\mathsf{min}+\mathsf{i}}$.
