...
\end{bmatrix},
\] 
\caption{\langfor constructible matrices encoding order information.}\label{fig:ordermat}
\end{figure}
...
Later on, in the proof of Proposition~\ref{prop:inverse}, we will need  matrix powers $\mathsf{Next}^i$ of $\mathsf{Next}$, where $i$ is specified as
