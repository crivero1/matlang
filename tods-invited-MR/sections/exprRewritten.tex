...
\item When it comes to the reverse direction, our conjecture is that it does not hold in general. However, we show that if we consider circuit families of polynomial degree, we can always construct an equivalent \langfor expression. This result is presented in Theorem~\ref{th-circuits-ml}, and is the main technical result of this section.
\item Finally, we discuss how to isolate a fragment of \langfor equivalent to polynomial degree families of arithmetic circuits (Subsection~\ref{subsec:actoformatlang}), and how to extend \langfor with additional operators (Subsection~\ref{subsec:additionalop}).
\end{itemize}
}
