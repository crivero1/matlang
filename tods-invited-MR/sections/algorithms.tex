...
\begin{minipage}{0.49\textwidth}
    \begin{algorithmic}[1]
        \Function{\textsc{LU}}{$A$}\Comment{Input: $n\times n$ matrix $A$}
            ...
            \For{$i=1,2,\ldots,n$}
                \State{\hspace{-2ex}$A_i\coloneqq T_{i-1}\cdot A_{i-1}$}
				\State{\hspace{-2ex}$T_i\coloneqq$\textsc{GetReduceMatrix}$(A_i,i)$}
                \State{\hspace{-2ex}$L^{-1}_i\coloneqq T_i\cdot T_{i-1}$}
