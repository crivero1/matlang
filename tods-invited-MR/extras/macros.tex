...
\newcommand{\IfThenElse}[3]{\mathsf{if}\hspace{1ex}\lbrace\hspace{1ex}#1\hspace{1ex}\rbrace\hspace{1ex}\mathsf{then}\hspace{1ex}\lbrace\hspace{1ex}#2\hspace{1ex}\rbrace\hspace{1ex}\mathsf{else}\hspace{1ex}\lbrace\hspace{1ex}#3\hspace{1ex}\rbrace}
\newcommand{\IfThenNoElse}[3]{\mathsf{if}\hspace{1ex}\lbrace\hspace{1ex}#1\hspace{1ex}\rbrace\hspace{1ex}\mathsf{then}\hspace{1ex}\lbrace\hspace{1ex}#2\hspace{1ex}\rbrace\hspace{1ex}\mathsf{else}}
...
\newcommand{\isless}{\mathsf{isLess}}
\newcommand{\islessorequal}{\mathsf{isLessOrEqual}}

\newcommand{\ccol}[2]{\texttt{col(}#1,#2\texttt{)}}
\newcommand{\red}[2]{\texttt{reduce(}#1,#2\texttt{)}}
\newcommand{\redd}[2]{\texttt{reduce'(}#1,#2\texttt{)}}
...
\newcommand{\isplus}[1]{\texttt{isplus}(#1)}
\newcommand{\isprod}[1]{\texttt{isprod}(#1)}
\newcommand{\isone}[1]{\texttt{isone}(#1)}
\newcommand{\iszero}[1]{\texttt{iszero}(#1)}
\newcommand{\isinput}[1]{\texttt{isinput}(#1)}
\newcommand{\getfirst}[1]{\texttt{getfirst}(#1)}
\newcommand{\getinput}[1]{\texttt{getinput}(#1)}
\newcommand{\getroot}{\texttt{getroot}()}
\newcommand{\isnotlast}[2]{\texttt{not{\_}last}(#1,#2)}
\newcommand{\nextgate}[2]{\texttt{next{\_}gate}(#1, #2)}

\newcommand{\Iden}[1]{\mathsf{IdUpTo}(#1)}
\newcommand{\pondIden}[2]{\mathsf{IdVal}(#1, #2)}
