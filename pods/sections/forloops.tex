...
\cristian{I would put this kind of examples in the intro.}
...
As a final example, we show that we can express the $4\textsf{clique}$ program mentioned at the beginning of this section.
