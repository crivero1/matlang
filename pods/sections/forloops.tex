...
\floris{We should indeed describe the differences with \lang: we do not have one-vector and diagonalisation.
Also, weren't we going to restrict function applications to scalars only? It is mentioned that a difference is
function application, but this is also included in the previous section for \lang}
\medskip
