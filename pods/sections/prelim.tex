...
%
%The syntax of MATLANG expressions over the vocabulary $\Voc$ is defined by the following grammar:
%
%\begin{tabular}{lcll}
...
%\end{tabular}
%\label{tab-types}
%\caption{Type of MATLANG expression $e$ over an instance $\I$.}
%\end{table}
