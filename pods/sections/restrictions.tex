...
$$
where $I$ is the identity matrix. It is readily verified that  $\sprod v$ can expressed in terms of $\qhadprod v$.
...
\begin{proposition}
	Every expression in \langprod can be defined in \langsum extended with $\sprod v$. Moreover, there exists an expression that uses the $\sprod v$ quantifier that cannot be defined in \langprod.
\end{proposition}
