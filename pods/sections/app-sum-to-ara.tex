...
\thomas{I feel like I'm missing something because I don't mention the relations $R_\alpha^{\text{Rel}(\I)}(t)$. Or they exist just for the active domain in ARA and to ensure everything works fine? (like encoding the zero matrix) Should I say something more about this?}
