...
\DONE In particular, the semantics of (for-)MATLANG expressions is not well-defined, as no 
...
\DONE You have to state the operator priorities of MATLANG and for-MATLANG.\thomas{Working on this. Accepting suggestions.}
...
\DONE I do not understand why an Instance has to assign values to the size symbols.
